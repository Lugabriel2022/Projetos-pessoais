...
class Funcs:
    ...
    def ficha(self):
        ...
        if self.var_g.get() == "F" and raça1 in [
            "Humano",
            "Elfo",
            "Kobolt",
            "Gigante",
        ...
        if classe1 in ["Mago", "Feiticeiro", "Artifice"] or raça1 in [
            "Dragão",
            "Long",
            "Kitsune",
        ]:
...
class Application(Funcs):
    ...
    def widgets_frame_1(self):
        # botão save
        self.bt_save = ttk.Button(
            self.frame_1, text="Save", command=self.salvar_personagem
        )
        ...
        # checkbox sexo
        self.rd_sexo_1 = ttk.Radiobutton(
            self.frame_1, text="Masculino", variable=self.var_g, value="M"
        )
        self.rd_sexo_1.place(relx=0.02, rely=0.43)
        self.rd_sexo_2 = ttk.Radiobutton(
            self.frame_1, text="Feminino", variable=self.var_g, value="F"
        )
    ...
    def widgets_frame_4(self):
        # labels
        self.lb_magi = Label(
            self.frame_4, text="Caracteristicas magicas", bg="lightgray"
        )
