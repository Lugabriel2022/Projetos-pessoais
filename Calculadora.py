...
class App(Funcs):
    ...
    def Teclado(self):
        ...
        self.bt_add = ttk.Button(
            self.tec, text="+", command=lambda: self.Inserir_valor(" + ")
        )
        self.bt_min = ttk.Button(
            self.tec, text="-", command=lambda: self.Inserir_valor(" - ")
        )
        self.bt_mult = ttk.Button(
            self.tec, text="X", command=lambda: self.Inserir_valor(" * ")
        )
        self.bt_div = ttk.Button(
            self.tec, text="/", command=lambda: self.Inserir_valor(" / ")
        )
        self.bt_ce = ttk.Button(self.tec, text="CE", command=self.Limpar)
        self.bt_ig = ttk.Button(self.tec, text="=", command=self.Calc)
        self.bt_pt = ttk.Button(
            self.tec, text=".", command=lambda: self.Inserir_valor(".")
        )
        self.bt_el = ttk.Button(
            self.tec, text="^", command=lambda: self.Inserir_valor(" ** ")
        )
        self.bt_r2 = ttk.Button(
            self.tec, text="√", command=lambda: self.Inserir_valor(" ** 0.5")
        )
        self.bt_pa = ttk.Button(
            self.tec, text="(", command=lambda: self.Inserir_valor("( ")
        )
        self.bt_pf = ttk.Button(
            self.tec, text=")", command=lambda: self.Inserir_valor(" )")
        )
        # botões numéricos
        self.bt_n1 = ttk.Button(
            self.tec, text="1", command=lambda: self.Inserir_valor("1")
        )
        self.bt_n2 = ttk.Button(
            self.tec, text="2", command=lambda: self.Inserir_valor("2")
        )
        self.bt_n3 = ttk.Button(
            self.tec, text="3", command=lambda: self.Inserir_valor("3")
        )
        self.bt_n4 = ttk.Button(
            self.tec, text="4", command=lambda: self.Inserir_valor("4")
        )
        self.bt_n5 = ttk.Button(
            self.tec, text="5", command=lambda: self.Inserir_valor("5")
        )
        self.bt_n6 = ttk.Button(
            self.tec, text="6", command=lambda: self.Inserir_valor("6")
        )
        self.bt_n7 = ttk.Button(
            self.tec, text="7", command=lambda: self.Inserir_valor("7")
        )
        self.bt_n8 = ttk.Button(
            self.tec, text="8", command=lambda: self.Inserir_valor("8")
        )
        self.bt_n9 = ttk.Button(
            self.tec, text="9", command=lambda: self.Inserir_valor("9")
        )
        self.bt_n0 = ttk.Button(
            self.tec, text="0", command=lambda: self.Inserir_valor("0")
        )
        # places funcs
